      ...
      <div className="relative ml-auto pt-36">
       <div className="mx-auto text-center lg:w-2/3">
        ...
        <p className="mt-8 text-gray-700 dark:text-gray-300">
         Forje personagens únicos e mergulhe em aventuras inesquecíveis.
        </p>

        <div className="mt-16 flex flex-wrap justify-center gap-x-6 gap-y-4">
         <button
          onClick={sessionData ? () => void signOut() : () => void signIn()}
          className="before:bg-primary/10 relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:border before:border-transparent before:bg-gradient-to-b before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-pink-500 dark:before:bg-pink-600 sm:w-max"
         >
